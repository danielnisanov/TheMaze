...
public class ShiftController {
    private final ShiftHRepositoryWorkers shiftHRepository;
    private final WorkersRepositoryWorkers workersRepository;
    private final WorkArrangementRepositoryWorkers workArrangementRepository;
    private final WorkersOnShiftRepositoryWorkers workersOnShiftRepository;

    public ShiftController(ShiftHRepositoryWorkers shiftHRepository, WorkersRepositoryWorkers workersRepository, WorkArrangementRepositoryWorkers workArrangementRepository, WorkersOnShiftRepositoryWorkers workersOnShiftRepository) {
    ...
    public boolean add_worker_to_weekly_arrangement(Branch branch, Worker worker, String day, String shiftType, Role role) {
        boolean success = workersOnShiftRepository.InsertShiftWA(worker,getDayIndex(day)*2 + getShiftIndex(shiftType)) && workersOnShiftRepository.InsertShiftSH(worker,getDayIndex(day),shiftType) ;
