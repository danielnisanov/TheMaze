...
public class Menu {
    ...
    private Presentation.ProductPresentation productPresentation;
    private CategoryPresentation categoryPresentation;
    private Presentation.ReportPresentation reportPresentation;

    public Menu() {
        scanner = new Scanner(System.in);
        productPresentation = new Presentation.ProductPresentation(scanner);
        categoryPresentation = new CategoryPresentation(scanner);
        reportPresentation = new Presentation.ReportPresentation(scanner);
    }
